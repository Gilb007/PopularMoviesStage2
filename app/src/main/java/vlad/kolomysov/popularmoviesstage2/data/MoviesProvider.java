package vlad.kolomysov.popularmoviesstage2.data;
...
import vlad.kolomysov.popularmoviesstage2.data.MoviesDbHelper;
        ...
        switch (match) {
            case MOVIE:
                ...
                try {
                    ...
                    Logger.log(TAG," insterted  "+values.length);
