...
import vlad.kolomysov.popularmoviesstage2.BuildConfig;
import vlad.kolomysov.popularmoviesstage2.R;
import vlad.kolomysov.popularmoviesstage2.activity.MovieDetailActivity;
import vlad.kolomysov.popularmoviesstage2.activity.SettingsActivity;
import vlad.kolomysov.popularmoviesstage2.adapter.ReviewsAdapter;
...
public class MovieDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private void initViews(View view) {
        ...
        PopularMovieApplication.mPicasso.load(AppUtils.createPosterUrl(mMovie.getPoster_path())).into(poster);
